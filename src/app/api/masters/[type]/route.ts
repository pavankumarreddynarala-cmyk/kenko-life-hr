...
export async function POST(req: NextRequest, { params }: { params: Promise<{ type: string }> }) {
  try {
    ...
    return NextResponse.json(
      { error: message === "FORBIDDEN" ? "Management access required" : "That name or code already exists" },
